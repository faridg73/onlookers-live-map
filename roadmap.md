...
- [x] Sync the latest iOS workflow fixes to GitHub and start a new workflow run.
- [x] Review the complete failure log if the new workflow run fails.
- [x] Google Play: build the signed Android bundle and upload it to the internal testing release.
- [x] Fix map safe-area controls, add a clickable five-mile nearby bounty list, and use miles throughout.
