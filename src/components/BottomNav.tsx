...
export function BottomNav() {
  ...
  return (
    <nav className={`pointer-events-auto fixed inset-x-0 bottom-0 z-40 border-t pb-safe backdrop-blur-2xl ${isHome ? "border-home-line bg-home-glass-strong shadow-2xl" : "border-border/70 bg-surface/85"}`}>
