...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Archivo+Black&family=Big+Shoulders+Display:ital,wght@1,800;1,900&family=Hind:wght@400;500;600;700&family=Inter:wght@400;500&family=Space+Grotesk:wght@500;600;700&display=swap",
      },
