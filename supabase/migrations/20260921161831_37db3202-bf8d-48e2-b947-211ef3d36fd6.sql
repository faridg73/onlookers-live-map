ALTER TABLE public.community_posts ADD COLUMN IF NOT EXISTS event_starts_at timestamp with time zone;

CREATE INDEX IF NOT EXISTS community_posts_event_starts_at_idx
  ON public.community_posts (event_starts_at)
